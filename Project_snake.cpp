...
int main()
{
    ...
    while (true) // бесконечное выполнение программы 
    {
        ...
        // создаём таймер и инициализируем 0, для того чтобы в следующей итерации цикла таймер начинался заново
        ...
        bool checkWin = false;// запускаем игру
        while (check)
        {
            ...
            if (resultTime > timeLive)
                break;
            // выводим таймер
            printf("  Time: %4d", (timeLive / 1000 - resultTime / 1000) - 1);
